...
input_remainder=$((datum_lovelace - billable_amount - platform_fee - anchor_output_cost))

if (( input_remainder < 0 )); then
    ...
    input_remainder=$((input_total - billable_amount - platform_fee - anchor_output_cost))
